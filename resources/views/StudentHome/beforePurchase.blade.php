        ...
        <style>
            ...
            * {
            ...
            .course_description {
                ...
                flex: 1;
                overflow-y: auto;
                /* Add this to make the course description scrollable */
                max-height: 300px;
                /* Set a maximum height for scrollable content (adjust as needed) */
            }
            ...
            .table-of-contents {
                margin-top: 20px;
                width: 100%;
                /* Set the width to 100% to prevent overlap */
            }
    ...
    <div class="main_container">
        ...
        <div class="con2">
            ...
            <form class="contribution-form" id="contribution-form" method="POST"
                action="{{ route('payment', ['data' => $course]) }}">
                @csrf

                <script src="https://checkout.razorpay.com/v1/checkout.js" data-key="{{ env('rzr_key') }}"
                    data-amount="{{ $course['price'] * 100 }}" data-name="online web tutorials"
                    data-description="Razorpay Payment Example" data-image="{{ asset('logo.png') }}" data-prefill.email="email"
    ...
    <script>
        ...
        if (course) {
            ...
            course.modules.forEach((module, index) => {
                ...
                moduleDiv.innerHTML =
                `<p><strong>Module ${index + 1}:</strong> ${module.description}</p>`; // Title : Description
